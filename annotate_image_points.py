...
def draw_point(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDBLCLK:   
        cv2.drawMarker(cv2.UMat(img), (x, y), color=(255,255,255), markerType=cv2.MARKER_CROSS, markerSize=5)
...
if __name__ == '__main__':
    ...
    image_path = '/home/shubham/Pictures/bdr_band_image_shubham_roy_version_no_1/'#change your dataset path
